...
enum class MinecraftFormatting(
    ...
    OBFUSCATED("k", JBColor(Color(50, 50, 50, 150), Color(70, 70, 70, 150)), JBColor(Gray._200, Gray._180), "Obfuscated"),
    BOLD("l", JBColor(Color(240, 240, 240, 150), Color(220, 220, 220, 150)), JBColor(Gray._30, Gray._50), "Bold"),
    STRIKETHROUGH("m", JBColor(Color(255, 200, 200, 150), Color(220, 170, 170, 150)), JBColor(Color(100, 0, 0), Color(130, 30, 30)), "Strikethrough"),
    UNDERLINE("n", JBColor(Color(200, 220, 255, 150), Color(170, 190, 220, 150)), JBColor(Color(0, 0, 150), Color(30, 30, 180)), "Underline"),
    ITALIC("o", JBColor(Color(255, 255, 220, 150), Color(220, 220, 190, 150)), JBColor(Color(100, 100, 0), Color(130, 130, 30)), "Italic"),
    ...
    companion object {
        ...
        fun fromCode(code: String): MinecraftFormatting? = BY_CODE[code.lowercase()]
