...
class LangKeyNavigationElement(
    ...
    override fun addRangeBefore(first: PsiElement, last: PsiElement, anchor: PsiElement?): PsiElement = this
    ...
    override fun isValid(): Boolean = psiFile.isValid && lineIndex >= 0
